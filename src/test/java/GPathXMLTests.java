...
public class GPathXMLTests extends VideoGameConfig {
    ...
    public void getFirstGameInList() {
        ...
        Response response = given().header("Content-Type", "application/xml")
                .header("Accept", "application/xml").get(VideoGamesEndpoints.ALL_VIDEO_GAMES);
    ...
    public void getListOfXmlNodes() {
        ...
        String responseAsString = given().header("Content-Type", "application/xml")
                .header("Accept", "application/xml")
                .get(VideoGamesEndpoints.ALL_VIDEO_GAMES).asString();
